...
<footer id="footer" class="outer black">
	<div id="footer-navigation" class="inner">
		...
		<div id="footer-socials">
			<ul>
				...
				<li class="social facebook"><a href="https://www.facebook.com/20storieshigh/"><img src="<?php echo get_template_directory_uri(); ?>/images/social-facebook.svg" alt="Facebook" width="33" height="33" /></a></li>
				<li class="social spotify"><a href="https://open.spotify.com/artist/6QP03DyHxmMPteuLaCEqPS?si=OjwK6sINQhWQZyYleellkA"><img src="<?php echo get_template_directory_uri(); ?>/images/social-spotify.svg" alt="Spotify" width="33" height="33" /></a></li>
				...
				<li class="social linkedin"><a href="https://www.linkedin.com/company/20-stories-high/posts/" rel="noopener"><img src="<?php echo get_template_directory_uri(); ?>/images/social-linked-in.svg" alt="LinkedIn" width="36" height="36" /></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="footer-legal inner">
		<?php echo get_field('legal_links', 'options'); ?>
	</div>
</footer>
<?php wp_footer(); ?>
<script>
